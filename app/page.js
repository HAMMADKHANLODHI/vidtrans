      ...
      <div className={`mt-[5%] flex w-[100%] h-[28.5rem] transition ${previewUrl ? '' : 'hidden'}`}>
        <div className="left-[2.5%] h-full w-[50%]">
          ...
          <div className="flex justify-around text-[1rem] h-[3rem] mt-[0.5rem] ">
              ...
              <h4 className="flex justify-center rounded-2xl items-center bg-gradient-to-r from-[#6474FF] to-[#7e6bbc] text-white w-[40%] cursor-pointer left-[2.5%] hover:bg-blue-600 transition">Source Language
              <img
                src="/icon/dropdowns.svg"
                alt="My Icon"
                className={`opacity-1118 svg-blue  h-[100%] ${isSumm ? 'hidden' : ''}`}
              />
              </h4>
              
              <h4 className="flex justify-center rounded-2xl items-center bg-gradient-to-r from-[#6474FF] to-[#7e6bbc] text-white w-[40%] cursor-pointer left-[2.5%] hover:bg-blue-600 transition">Target Language
              <img
                src="/icon/dropdowns.svg"
                alt="My Icon"
                className={`opacity-1118 svg-blue  h-[100%] ${isSumm ? 'hidden' : ''}`}
